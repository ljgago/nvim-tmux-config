...
#date_format=$(get "@onedark_date_format" "%a %e %b")
date_format=$(get "@onedark_date_format" "%d-%m-%Y")

# set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format} #[fg=$onedark_white,bg=$onedark_visual_grey,nounderscore,noitalics] ${date_format} #[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #[fg=$onedark_black,bg=$onedark_green,bold] #h #[fg=$onedark_yellow, bg=$onedark_green] "
...
set "window-status-format" "#[fg=$onedark_white,bg=$onedark_black] #I - #W #[fg=$onedark_black,bg=$onedark_black,nobold,nounderscore,noitalics]"
